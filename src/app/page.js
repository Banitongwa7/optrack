        ...
        <table className="min-w-max w-full table-auto">
          ...
          <tbody className="text-gray-600 text-sm">
            ...
            <tr className="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
              <td className="py-3 px-6 text-left">Vuejs</td>
              <td className="py-3 px-6 text-left">
                <div className="flex items-center">
                  <div className="mr-2">
                    <Image
              ...
              <td className="py-3 px-6 text-center">665</td>
              <td className="py-3 px-6 text-center">
            ...
            <tr className="border-b border-gray-200 hover:bg-gray-100">
              ...
              <td className="py-3 px-6 text-center">787</td>
              <td className="py-3 px-6 text-center">
            ...
            <tr className="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
              <td className="py-3 px-6 text-left">Laravel</td>
              <td className="py-3 px-6 text-left">
                <div className="flex items-center">
                  <div className="mr-2">
                    <Image
              ...
              <td className="py-3 px-6 text-center">873</td>
              <td className="py-3 px-6 text-center">
            ...
            <tr className="border-b border-gray-200 hover:bg-gray-100">
              <td className="py-3 px-6 text-left">GIT Project</td>
              <td className="py-3 px-6 text-left">
                <div className="flex items-center">
                  <div className="mr-2">
                    <Image
              ...
              <td className="py-3 px-6 text-center">1294</td>
              <td className="py-3 px-6 text-center">
                <span className="bg-purple-200 text-purple-600 py-1 px-3 rounded-full text-xs">
                  Active
                </span>
            ...
            <tr className="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
              <td className="py-3 px-6 text-left">JavaScript</td>
              <td className="py-3 px-6 text-left">
                <div className="flex items-center">
                  <div className="mr-2">
                    <Image
              ...
              <td className="py-3 px-6 text-center">3763</td>
              <td className="py-3 px-6 text-center">
                <span className="bg-yellow-200 text-yellow-600 py-1 px-3 rounded-full text-xs">
                  Scheduled
                </span>
            ...
            <tr className="border-b border-gray-200 hover:bg-gray-100">
              <td className="py-3 px-6 text-left">Python3</td>
              <td className="py-3 px-6 text-left">
                <div className="flex items-center">
                  <div className="mr-2">
                    <Image
              ...
              <td className="py-3 px-6 text-center">509</td>
              <td className="py-3 px-6 text-center">
                <span className="bg-red-200 text-red-600 py-1 px-3 rounded-full text-xs">
                  Pending
                </span>
